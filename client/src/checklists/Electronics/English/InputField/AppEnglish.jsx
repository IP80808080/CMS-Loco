...
function AppElexEnglish() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/submitForm/English`, {
        sign: sign,
        uid,
        ...
        {showForm ? (
          <div>
            <div className="flex flex-col justify-center px-8">
              ...
              <Footer uid={uid} sign={sign} sign_supervisor={sign_supervisor} />
