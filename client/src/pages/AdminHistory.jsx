...
export default function AdminHistory() {
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/EMC/getAcceptedFormsHistory`
        );
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/VCBSBAREVA/getAcceptedFormsHistory`
        );
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/English/getAcceptedFormsHistory`
        );
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/QD/getAcceptedFormsHistory`
        );
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/flasher/getAcceptedFormsHistory`
        );
  ...
  useEffect(() => {
    const fetchHistoryData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/api/FDCS/getAcceptedFormsHistory`
        );
                  ...
                  forms
                    ...
                    .map((form) => (
                      ...
                      >
                        ...
                        <th className="px-6 py-3 font-medium text-gray-900">
                          <div className="flex justify-center">QD</div>
                        </th>
                        <th className="px-6 py-3 font-medium text-gray-900">
                          <div className="flex justify-center">
                            {form.section}
                  ...
                  forms
                    ...
                    .map((form) => (
                      ...
                      >
                        ...
                        <th className="px-6 py-3 font-medium text-gray-900">
                          <div className="flex justify-center">VCBSBAREVA</div>
                        </th>
                        <th className="px-6 py-3 font-medium text-gray-900">
                          <div className="flex justify-center">
                            {form.section}
