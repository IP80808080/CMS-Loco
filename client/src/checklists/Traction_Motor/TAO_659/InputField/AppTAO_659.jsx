...
import Details from "../TemplateTAO_659/details";
import Table from "../TemplateTAO_659/table";
...
function AppTAO() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/submitForm/TAO_659`, {
        stator_no,
        armature_no,
        bhrr_no,
        kmo_no,
