...
function RevertHistoryInputFieldELEXQD() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/api/revert/E-QD/${uid}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/resubmit/QD`, {
        sign: sign,
        uid,
...
export default RevertHistoryInputFieldELEXQD;
