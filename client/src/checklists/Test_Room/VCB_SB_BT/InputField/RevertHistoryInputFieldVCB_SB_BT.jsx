...
function RevertHistoryInputFieldVCB_SB_BT() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`/revert/Au-VCB_SB_BT/${uid}`);
      ...
      setData({
        ...
        std_value13: fetchedData.std_value13,
...
export default RevertHistoryInputFieldVCB_SB_BT;
