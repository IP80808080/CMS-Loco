...
function RevertHistoryInputFieldOCB() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/revert/Au-ocb/${uid}`);
      ...
      setData({
        ...
        mecPar: fetchedData.mecPar,
        productionDate: fetchedData.productionDate,
        u: fetchedData.u,
        v: fetchedData.v,
        w: fetchedData.w,
        vastvik2: fetchedData.vastvik2,
        uv3: fetchedData.uv3,
        vw3: fetchedData.vw3,
        wu3: fetchedData.wu3,
        ...
        vastvik15: fetchedData.vastvik15,
        u16: fetchedData.u16,
        v16: fetchedData.v16,
        w16: fetchedData.w16,
        u16_1: fetchedData.u16_1,
        de17: fetchedData.de17,
        body18: fetchedData.body18,
        de18: fetchedData.de18,
        nde18: fetchedData.nde18,
        nde17: fetchedData.nde17,
        tarik19: fetchedData.tarik19,
        mek19: fetchedData.mek19,
        tarik19_1: fetchedData.tarik19_1,
        mek19_1: fetchedData.mek19_1,
        vastvik19_1: fetchedData.vastvik19_1,
        vastvik19_2: fetchedData.vastvik19_2,
        vastvik20: fetchedData.vastvik20,
        vastvik21: fetchedData.vastvik21,
        vastvik3: fetchedData.vastvik3,
        wu5: fetchedData.wu5,
        vastvik21_1: fetchedData.vastvik21_1,
        v162: fetchedData.v162,
        w163: fetchedData.w163,
        vw5: fetchedData.vw5,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/resubmit/ocb`, {
        equipmentNumber,
        commissioningDate,
        mecPar,
        productionDate,
...
export default RevertHistoryInputFieldOCB;
