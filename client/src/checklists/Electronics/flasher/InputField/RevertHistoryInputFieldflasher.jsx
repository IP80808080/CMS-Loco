...
function RevertHistoryInputFieldflasher() {
  ...
  const fetchData = async () => {
    try {
      ...
      setData({
        ...
        make: fetchedData.setMake,
        equipmentNumber: fetchedData.equipmentNumber,
        removed_locono: fetchedData.removed_locono,
        fitted_locono: fetchedData.fitted_locono,
        schedule: fetchedData.schedule,
        actual_1: fetchedData.actual_1,
        actual_2: fetchedData.actual_2,
        actual_3: fetchedData.actual_3,
        actual_4: fetchedData.actual_4,
        actual_5: fetchedData.actual_5,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/resubmit/flasher`, {
        date_overhaul,
        sign: sign,
        uid,
...
export default RevertHistoryInputFieldflasher;
