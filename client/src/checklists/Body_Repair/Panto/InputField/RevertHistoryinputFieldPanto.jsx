...
function RevertHistoryInputFieldPanto() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/api/revert/BR-Panto/${uid}`
      );
      ...
      setData({
        ...
        loco_no: fetchedData.loco_no,
        date: fetchedData.date,
        photo1_srno: fetchedData.photo1_srno,
        make_photo1: fetchedData.make_photo_1,
        overhaul_photo1: fetchedData.overhaul_photo1,
        servomotor1_srno: fetchedData.servomotor1_srno,
        make_servomotor1: fetchedData.make_servomotor1,
        overhaul_servomotor1: fetchedData.overhaul_servomotor1,
        photo2_srno: fetchedData.photo2_srno,
        make_photo2: fetchedData.make_photo2,
        overhaul_photo2: fetchedData.overhaul_photo2,
        servomotor2_srno: fetchedData.servomotor2_srno,
        make_servomotor2: fetchedData.make_servomotor2,
        overhaul_servomotor2: fetchedData.overhaul_servomotor2,
        remark3_1: fetchedData.remark3_1,
        remark3_2: fetchedData.remark3_2,
        remark3_3: fetchedData.remark3_3,
        remark3_4: fetchedData.remark3_4,
        remark3_5: fetchedData.remark3_5,
        remark3_6: fetchedData.remark3_6,
        remark3_7: fetchedData.remark3_7,
        remark4: fetchedData.remark4,
        remark4_1: fetchedData.remark4_1,
        remark4_2: fetchedData.remark4_2,
        remark5: fetchedData.remark5,
        remark6_1: fetchedData.remark6_1,
        remark6_2: fetchedData.remark6_2,
        remark6_3: fetchedData.remark6_3,
        remark6_4: fetchedData.remark6_4,
        remark7_1: fetchedData.remark7_1,
        remark7_2: fetchedData.remark7_2,
        remark7_3: fetchedData.remark7_3,
        remark8_1: fetchedData.remark8_1,
        remark8_2: fetchedData.remark8_2,
        remark8_3: fetchedData.remark8_3,
        remark9_1: fetchedData.remark9_1,
        remark9_2: fetchedData.remark9_2,
        remark10: fetchedData.remark10,
        remark11_1: fetchedData.remark11_1,
        remark11_2: fetchedData.remark11_2,
        remark11_3: fetchedData.remark11_3,
        remark11_4: fetchedData.remark11_4,
        remark12: fetchedData.remark12,
        remark13: fetchedData.remark13,
        remark14: fetchedData.remark14,
        remark15: fetchedData.remark15,
        remark16_1: fetchedData.remark16_1,
        remark16_2: fetchedData.remark16_2,
        remark16_3: fetchedData.remark16_3,
        remark16_4: fetchedData.remark16_4,
        remark16_5: fetchedData.remark16_5,
        remark16_6: fetchedData.remark16_6,
        remark17_1: fetchedData.remark17_1,
        remark17_2: fetchedData.remark17_2,
        remark18: fetchedData.remark18,
        remark19: fetchedData.remark19,
        remark20: fetchedData.remark20,
        sign1_karmachari: fetchedData.sign1_karmachari,
        sign1_examinarsection: fetchedData.sign1_examinarsection,
        sign1_anurakshan: fetchedData.sign1_anurakshan,
        sign1_ppio: fetchedData.sign1_ppio,
        remark21: fetchedData.remark21,
        remark22: fetchedData.remark22,
        remark23: fetchedData.remark23,
        remark24: fetchedData.remark24,
        remark25: fetchedData.remark25,
        remark26: fetchedData.remark26,
        remark27: fetchedData.remark27,
        remark28: fetchedData.remark28,
        remark29: fetchedData.remark29,
        remark30: fetchedData.remark30,
        remark31: fetchedData.remark31,
        remark32: fetchedData.remark32,
        remark33: fetchedData.remark33,
        remark34: fetchedData.remark34,
        sign2_karmachari: fetchedData.sign2_karmachari,
        sign2_examinarsection: fetchedData.sign2_examinarsection,
        sign2_anurakshan: fetchedData.sign2_anurakshan,
        sign2_ppio: fetchedData.sign2_ppio,
        change_1: fetchedData.change_1,
        make_1: fetchedData.make_1,
        change_2: fetchedData.change_2,
        make_2: fetchedData.make_2,
        change_3: fetchedData.change_3,
        make_3: fetchedData.make_3,
        change_4: fetchedData.change_4,
        make_4: fetchedData.make_4,
        change_5: fetchedData.change_5,
        make_5: fetchedData.make_5,
        change_6: fetchedData.change_6,
        make_6: fetchedData.make_6,
        change_7: fetchedData.change_7,
        make_7: fetchedData.make_7,
        change_8: fetchedData.change_8,
        make_8: fetchedData.make_8,
        change_9: fetchedData.change_9,
        make_9: fetchedData.make_9,
        change_10: fetchedData.change_10,
        make_10: fetchedData.make_10,
        sign3_karmachari: fetchedData.sign3_karmachari,
        sign3_examinarsection: fetchedData.sign3_examinarsection,
        sign3_anurakshan: fetchedData.sign3_anurakshan,
        sign3_ppio: fetchedData.sign3_ppio,
      });
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/resubmit/Panto`, {
        uid,
        equipmentNumber,
        loco_no,
        date,
...
export default RevertHistoryInputFieldPanto;
