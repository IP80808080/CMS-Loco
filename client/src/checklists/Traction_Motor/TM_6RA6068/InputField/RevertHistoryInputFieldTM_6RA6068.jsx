...
function RevertHistoryInputfieldTM() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/api/revert/TM-TM_6RA6068/${uid}`
      );
      ...
      setData({
        ...
        TMsr_no: fetchedData.TMsr_no,
        date_removed: fetchedData.date_removed,
        reason_removed: fetchedData.reason_removed,
        actualvalueI01: fetchedData.actualvalueI01,
        actualvalueI02: fetchedData.actualvalueI02,
        actualvalueI03: fetchedData.actualvalueI03,
        actualvalueI04: fetchedData.actualvalueI04,
        actualvalueI05: fetchedData.actualvalueI05,
        actualvalueI06: fetchedData.actualvalueI06,
        date_oh: fetchedData.date_oh,
        TMsr1_no: fetchedData.TMsr1_no,
        make_1: fetchedData.make_1,
        rotor_no: fetchedData.rotor_no,
        make_2: fetchedData.make_2,
        pinion_no: fetchedData.pinion_no,
        make_3: fetchedData.make_3,
        bearing_de: fetchedData.bearing_de,
        bearing_nde: fetchedData.bearing_nde,
        actualvalue_a1: fetchedData.actualvalue_a1,
        actualvalue_a2: fetchedData.actualvalue_a2,
        actualvalue_a3: fetchedData.actualvalue_a3,
        actualvalue_a4: fetchedData.actualvalue_a4,
        actualvalue_b1: fetchedData.actualvalue_b1,
        actualvalue_c1: fetchedData.actualvalue_c1,
        actualvalue_c2: fetchedData.actualvalue_c2,
        actualvalue_c3: fetchedData.actualvalue_c3,
        actualvalue_c4: fetchedData.actualvalue_c4,
        actualvalue_c4_1: fetchedData.actualvalue_c4_1,
        actualvalue_c5: fetchedData.actualvalue_c5,
        actualvalue_c6: fetchedData.actualvalue_c6,
        actualvalue_c7: fetchedData.actualvalue_c7,
        actualvalue_d1: fetchedData.actualvalue_d1,
        actualvalue_d2: fetchedData.actualvalue_d2,
        actualvalue_d3: fetchedData.actualvalue_d3,
        actualvalue_d4: fetchedData.actualvalue_d4,
        actualvalue_d5: fetchedData.actualvalue_d5,
        actualvalue_d6: fetchedData.actualvalue_d6,
        actualvalue_d7: fetchedData.actualvalue_d7,
        actualvalue_d8: fetchedData.actualvalue_d8,
        actualvalue_d9: fetchedData.actualvalue_d9,
        actualvalue_d10: fetchedData.actualvalue_d10,
        actualvalue_d11: fetchedData.actualvalue_d11,
        actualvalue_d12: fetchedData.actualvalue_d12,
        actualvalue_d13: fetchedData.actualvalue_d13,
        actualvalue_d14: fetchedData.actualvalue_d14,
        actualvalue_d15: fetchedData.actualvalue_d15,
        actualvalue_d16: fetchedData.actualvalue_d16,
        srno_e: fetchedData.srno_e,
        make_e: fetchedData.make_e,
        actualvalue_e1: fetchedData.actualvalue_e1,
        actualvalue_e2: fetchedData.actualvalue_e2,
        actualvalue_e3: fetchedData.actualvalue_e3,
        actualvalue_e4: fetchedData.actualvalue_e4,
        actualvalue_e4_1: fetchedData.actualvalue_e4_1,
        actualvalue_e5: fetchedData.actualvalue_e5,
        actualvalue_e6: fetchedData.actualvalue_e6,
        srno_f: fetchedData.srno_f,
        make_f: fetchedData.make_f,
        actualvalue_f1: fetchedData.actualvalue_f1,
        actualvalue_f2: fetchedData.actualvalue_f2,
        actualvalue_f3: fetchedData.actualvalue_f3,
        actualvalue_g1: fetchedData.actualvalue_g1,
        actualvalue_g2: fetchedData.actualvalue_g2,
        actualvalue_g3: fetchedData.actualvalue_g3,
        actualvalue_g4: fetchedData.actualvalue_g4,
        actualvalue_g5: fetchedData.actualvalue_g5,
        actualvalue_g6: fetchedData.actualvalue_g6,
        actualvalue_h1: fetchedData.actualvalue_h1,
        actualvalue_h2: fetchedData.actualvalue_h2,
        actualvalue_h3: fetchedData.actualvalue_h3,
        actualvalue_h4: fetchedData.actualvalue_h4,
        actualvalue_i1: fetchedData.actualvalue_i1,
        actualvalue_i2: fetchedData.actualvalue_i2,
        actualvalue_i3: fetchedData.actualvalue_i3,
        actualvalue_i4: fetchedData.actualvalue_i4,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${BASE_URL}/api/resubmit/TM_6RA6068`, {
        uid,
        loco_no,
        actualvalue_c4_1,
        srno_e,
...
export default RevertHistoryInputfieldTM;
